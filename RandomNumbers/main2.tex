...
The normal and the semilog graphs are plotted in Fig. \ref{fig:ErrorGraph2} and Fig. \ref{fig:ErrorGraph2_semilogy}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{./figures/ErrorGraph2_semilogy.png}
    \caption{$P_e$ vs $\gamma$ (semilogy)}
    \label{fig:ErrorGraph2_semilogy}
    \end{figure}
