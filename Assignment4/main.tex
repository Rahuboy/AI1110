...
\begin{abstract}
This document contains the solution for Assignment 4 (NCERT Class 9 Chapter 15 Example 4)
\end{abstract}
...
\begin{align}
    \pr{X = i} = \frac{N_i}{N}
\end{align} 
where $N_i$ is the frequency of occurrence of the digit $i$ and $N$ is the sum of the frequencies of occurrences of all digits.
